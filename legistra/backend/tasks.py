...
def analyze_document_task(self, doc_id):
    ...
    try:
        ...
        print(f"Tokenized input length after truncation: {len(tokens)}")
        ...
        print(f"Error in analyze_document_task: {e}")
    ...
    db_manager.store_analysis_result(doc_id, analysis, processing_time, model_versions)
